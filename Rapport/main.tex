...
\begin{document}
    ...
    Efter det tjekker vi om der bliver `pasted` tal ind i inputfeltet og laver en funktion,
...
public class RSADecrypter{
    ...
    \begin{center}
        \includegraphics[scale=0.5]{EncryptionLight}\label{img:encryption}  % Broken
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.6]{FactorizationLight}\label{img:factorization}  % Broken
    \end{center}
    ...
    \begin{center}
        \includegraphics[scale=0.5]{CrackingLight}\label{img:cracking}  % Broken
    \end{center}
