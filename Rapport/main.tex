...
\begin{document}
    ...
    I dette eksempel, er \(\textbf{m} = 2\), i tredje ligning og \(\textbf{m} = 106\) i anden ligning,
    ...
    Hvis tallet ikke indeholder bogstaver kører den koden mellem linje 9 og 12.
